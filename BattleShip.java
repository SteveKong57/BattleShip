/**
 *  Create a random location for a battleship on the grid that the user needs to find to hit all the parts of the ship.  
 *  Game ends when the user hits all parts of the ship.
 *
 * @author (Steve Kong)
 * @version (1.0)
 */
